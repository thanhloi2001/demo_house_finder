...
namespace Demo_Mock_House_Finder.Migrations
{
    ...
    [Migration("20240401102949_fixHouseTable")]
    partial class fixHouseTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Demo_Mock_House_Finder.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleID = 1,
                            CreatedDate = new DateTime(2024, 4, 1, 17, 29, 47, 300, DateTimeKind.Local).AddTicks(5921),
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleID = 2,
                            CreatedDate = new DateTime(2024, 4, 1, 17, 29, 47, 300, DateTimeKind.Local).AddTicks(5935),
                            RoleName = "Staff"
                        },
                        new
                        {
                            RoleID = 3,
                            CreatedDate = new DateTime(2024, 4, 1, 17, 29, 47, 300, DateTimeKind.Local).AddTicks(5936),
                            RoleName = "Landlord"
                        },
                        new
                        {
                            RoleID = 4,
                            CreatedDate = new DateTime(2024, 4, 1, 17, 29, 47, 300, DateTimeKind.Local).AddTicks(5937),
                            RoleName = "Student"
                        });
                });
