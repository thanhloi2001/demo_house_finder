...
namespace Demo_Mock_House_Finder.Migrations
{
    ...
    [Migration("20240402182419_editRateTable")]
            ...
            modelBuilder.Entity("Demo_Mock_House_Finder.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleID = 1,
                            CreatedDate = new DateTime(2024, 4, 3, 1, 24, 17, 990, DateTimeKind.Local).AddTicks(6387),
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleID = 2,
                            CreatedDate = new DateTime(2024, 4, 3, 1, 24, 17, 990, DateTimeKind.Local).AddTicks(6403),
                            RoleName = "Staff"
                        },
                        new
                        {
                            RoleID = 3,
                            CreatedDate = new DateTime(2024, 4, 3, 1, 24, 17, 990, DateTimeKind.Local).AddTicks(6404),
                            RoleName = "Landlord"
                        },
                        new
                        {
                            RoleID = 4,
                            CreatedDate = new DateTime(2024, 4, 3, 1, 24, 17, 990, DateTimeKind.Local).AddTicks(6405),
                            RoleName = "Student"
                        });
                });
